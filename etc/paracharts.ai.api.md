...
export const chartClasses: {
    ...
    waterfall: typeof WaterfallPlotView;
};
...
export class WaterfallBarView extends PlaneDatapointView {
    constructor(seriesView: PlaneSeriesView, _index: number);
    // (undocumented)
    readonly chart: WaterfallPlotView;
    // (undocumented)
    get classInfo(): {
        bar: boolean;
    };
...
export class WaterfallPlotView extends PlanePlotView {
    ...
    // (undocumented)
    protected _beginDatapointLayout(): void;
    // Warning: (ae-forgotten-export) The symbol "WaterfallChartInfo" needs to be exported by the entry point index-ai.d.ts
    //
    // (undocumented)
    protected _chartInfo: WaterfallChartInfo;
    // (undocumented)
    protected _createDatapoints(): void;
    // (undocumented)
    get numBars(): number;
